...
export const ProjectHeader = ({ project, currentUser }: ProjectHeaderProps) => {
  ...
  return (
    <div className="relative overflow-hidden border-b border-[var(--border-color)] bg-[var(--bg-main)] px-6 py-6">
      ...
      <div className="relative z-10 grid gap-5 lg:grid-cols-[1.25fr_0.75fr]">
        <div className="space-y-4">
          <div className="flex flex-wrap items-center gap-3">
            <BrandLockup variant="compact" subtitle="Board Identity" />
      ...
      {currentUser?.role === 'admin' ? (
        <div className="relative z-10 mt-5 rounded-[24px] border border-[var(--border-color)] bg-[rgba(255,255,255,0.04)] px-4 py-3 text-sm text-[var(--text-secondary)]">
          Admin controls task creation and final review for this board. Members can only accept, work on, and submit
